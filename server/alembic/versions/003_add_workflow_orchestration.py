...
def upgrade() -> None:
    ...
    op.create_unique_constraint(
        "uq_workflow_runs_idempotency_key", "workflow_runs", ["idempotency_key"]
    )
    ...
    op.create_unique_constraint(
        "uq_workflow_events_run_sequence", "workflow_events", ["run_id", "sequence"]
    )
...
def downgrade() -> None:
    ...
    op.drop_constraint(
        "uq_workflow_events_run_sequence", "workflow_events", type_="unique"
    )
    op.drop_table("workflow_events")
    op.drop_constraint(
        "uq_workflow_runs_idempotency_key", "workflow_runs", type_="unique"
    )
