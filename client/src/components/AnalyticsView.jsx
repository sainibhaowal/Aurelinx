  ...
  return (
    <div className="w-full pb-20">
      ...
      <div className="mt-8 grid grid-cols-1 xl:grid-cols-[1.1fr_0.9fr] gap-6 items-start">
        <section className="premium-card p-5 flex flex-col">
        ...
        <section className="premium-card p-5 flex flex-col min-h-full">
