      ...
      <header className="mb-8 flex items-start justify-between">
        <div>
          ...
          <p className="text-slate-400 text-sm md:text-base leading-relaxed max-w-3xl">
            Current organizational snapshot, derived indicators, and risk clustering.
          </p>
