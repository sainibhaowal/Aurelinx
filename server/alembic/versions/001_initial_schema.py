...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "join_date", sa.DateTime(), nullable=False, server_default=text("now()")
        ),
        sa.Column(
            "created_at", sa.DateTime(), nullable=False, server_default=text("now()")
        ),
    ...
    op.create_index(
        op.f("ix_employeetable_department"), "employeetable", ["department"]
    )
    op.create_index(
        op.f("ix_employeetable_email"), "employeetable", ["email"], unique=True
    )
    op.create_index(op.f("ix_employeetable_full_name"), "employeetable", ["full_name"])
    op.create_index(
        op.f("ix_employeetable_is_at_risk"), "employeetable", ["is_at_risk"]
    )
    ...
    op.create_index(
        op.f("ix_candidatetable_department"), "candidatetable", ["department"]
    )
    op.create_index(
        op.f("ix_candidatetable_email"), "candidatetable", ["email"], unique=True
    )
    op.create_index(
        op.f("ix_candidatetable_full_name"), "candidatetable", ["full_name"]
    )
    ...
    op.create_index(
        op.f("ix_experiences_candidate_id"), "experiences", ["candidate_id"]
    )
    ...
    op.create_index(
        op.f("ix_vector_embeddings_entity_id"), "vector_embeddings", ["entity_id"]
    )
    op.create_index(
        op.f("ix_vector_embeddings_entity_type"), "vector_embeddings", ["entity_type"]
    )
